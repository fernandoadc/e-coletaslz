  ...
  const getStatusText = (status) => {
    switch (status) {
      case "empty":
        return "Vazio";
      case "half":
        return "Parcialmente Cheio";
      case "full":
        return "Cheio - Aguardando Coleta";
      case "collected":
        return "Coletado";
      default:
        return "Desconhecido";
        ...
        <section className="bg-white rounded-xl shadow-sm">
          <div className="p-6 border-b">
            <h2 className="text-lg font-semibold text-gray-800">
              Seus Recipientes de Coleta
            </h2>
            <p className="text-sm text-gray-600 mt-1">
              Gerencie o status dos seus recipientes de vidro
            </p>
          </div>
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Última atualização:{" "}
                        {container.lastUpdate.toLocaleString()}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 flex-wrap">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full transition-all duration-300 ${
                            container.currentLevel >= 90
                              ? "bg-red-500"
                              : container.currentLevel >= 60
                                ? "bg-yellow-500"
                                : "bg-green-500"
                          }`}
                    ...
                    {/* Status */}
                    <div
                      className={`px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1 ${getStatusColor(container.status)}`}
                    >
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    Quando um recipiente estiver cheio, clique em "Marcar como
                    Cheio"
                  </li>
                  <li>
                    O sistema enviará automaticamente um alerta para os
                    coletores
                  </li>
                  <li>
                    Os coletores verão a localização no mapa e virão fazer a
                    coleta
                  </li>
                  <li>
                    Após a coleta, marque como "Coletado" para resetar o
                    recipiente
                  </li>
                </ul>
              </div>
